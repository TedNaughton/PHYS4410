...
fig = plt.figure()
plt.errorbar(distance1, count1, yerr=unc1, markersize=1.6, elinewidth=1, fmt='ro', label = 'Threshold: 0.2')
plt.errorbar(distance2, count2, yerr=unc2, markersize=1.6, elinewidth=1, fmt='bo', label = 'Threshold: 0.4')
plt.errorbar(distance3, count3, yerr=unc3, markersize=1.6, elinewidth=1, fmt='go', label = 'Threshold: 0.6')
plt.errorbar(distance4, count4, yerr=unc4, markersize=1.6, elinewidth=1, fmt='yo', label = 'Threshold: 0.8')
plt.errorbar(distance5, count5, yerr=unc5, markersize=1.6, elinewidth=1, fmt='co', label = 'Threshold: 1.1')
...
fig = plt.figure()
plt.errorbar(distance1[3:13], count1[3:13], yerr=unc1[3:13], markersize=1.6, elinewidth=1, fmt='ro', label = 'Bias: 0.2')
plt.errorbar(distance2[3:13], count2[3:13], yerr=unc2[3:13], markersize=1.6, elinewidth=1, fmt='bo', label = 'Bias: 0.4')
plt.errorbar(distance3[3:13], count3[3:13], yerr=unc3[3:13], markersize=1.6, elinewidth=1, fmt='go', label = 'Bias: 0.6')
plt.errorbar(distance4[3:13], count4[3:13], yerr=unc4[3:13], markersize=1.6, elinewidth=1, fmt='yo', label = 'Bias: 0.8')
plt.errorbar(distance5[3:13], count5[3:13], yerr=unc5[3:13], markersize=1.6, elinewidth=1, fmt='co', label = 'Bias: 1.1')
plt.xlabel('Distance (cm)')
plt.ylabel('Counting Rate ($s^{-1}$)')
plt.title('Detected Counting Rate of Alpha Particles vs Distance')
plt.legend()
plt.savefig('alphadataclose.png', dpi=300, bbox_inches='tight')
plt.close()
